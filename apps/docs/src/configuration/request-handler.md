...
::: warning Heads up!
If you include a catch block in the `requestHandler` function but don't explicitly throw the error, ReactList won't be able to detect and handle the error appropriately.
:::
